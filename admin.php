...
<?php else: ?>
    ...
    <body>
        ...
        <header>
            <nav>
                <div><button class="switch_tab" data-id="1">Заказы</button></div>
                <div><button class="switch_tab" data-id="1">Товары</button></div>
                <div><button class="switch_tab" data-id="1">Отзывы</button></div>
                <div><a href="ajax/logout_admin.php">
                        <button>Выход</button>
                    </a></div>
            </nav>
        </header>
            ...
            <div class="tab" style="display:block;" id="orders" data-id="1">
                ...
                <?php foreach ($orders as $order): ?>
                    <div class="order">
                        ...
                        <p>
                            <string>Логин: </strong><?= $order["Login"] ?>
                        </p>
                        <p>
                            <string>Телефон: </strong><?= $order["Phone"] ?>
                        </p>
                        <p>
                            <string>Дата: </strong><?= DateTime::createFromFormat("Y-m-d", $order["Date"])->format("d.m.Y") ?>
                        </p>
                        <p><strong>Товары: </strong></p>
                        <?php foreach ($order["Goods"] as $good): ?>
                            <p><?= $good["Name"] ?>, <?= $good["Price"] ?> * <?= $good["Count"] ?> =
            ...
            <div class="tab" id="goods" data-id="2">
                ...
                <?php foreach ($goods as $good): ?>
                    <form class="good">
                        ...
                        <p>Описание</p>
                        <div id="summernote"><?= $good["Description"] ?></div>
                        <div class="images">
